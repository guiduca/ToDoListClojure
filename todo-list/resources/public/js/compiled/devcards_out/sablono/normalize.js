...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__30957_SHARP_){
return ((p1__30957_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__30957_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__30959,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__30959;
}
});
...
var len__25923__auto___30962 = arguments.length;
var i__25924__auto___30963 = (0);
while(true){
if((i__25924__auto___30963 < len__25923__auto___30962)){
args__25930__auto__.push((arguments[i__25924__auto___30963]));

var G__30964 = (i__25924__auto___30963 + (1));
i__25924__auto___30963 = G__30964;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25931__auto__);
});
...
var G__30961 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__30961,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__30961;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq30960){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30960));
});
...
var vec__30970 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__30970,(0),null);
var names = cljs.core.nth.call(null,vec__30970,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__30970,tag_name,names){
return (function (p1__30965_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__30965_SHARP_));
});})(matches,vec__30970,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__30970,tag_name,names){
return (function (p1__30966_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__30966_SHARP_));
});})(matches,vec__30970,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__30973){
var vec__30980 = p__30973;
...
var tag = first__30982;
var content = seq__30981__$1;
...
var vec__30983 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__30983,(0),null);
var id = cljs.core.nth.call(null,vec__30983,(1),null);
var class$ = cljs.core.nth.call(null,vec__30983,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1523250220819