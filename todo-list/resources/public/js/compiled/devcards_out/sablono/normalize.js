...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__33041_SHARP_){
return ((p1__33041_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__33041_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__33043,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__33043;
}
});
...
var len__25923__auto___33046 = arguments.length;
var i__25924__auto___33047 = (0);
while(true){
if((i__25924__auto___33047 < len__25923__auto___33046)){
args__25930__auto__.push((arguments[i__25924__auto___33047]));

var G__33048 = (i__25924__auto___33047 + (1));
i__25924__auto___33047 = G__33048;
continue;
} else {
}
break;
...
var G__33045 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__33045,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__33045;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq33044){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33044));
});
...
var tag_name = cljs.core.nth.call(null,vec__33054,(0),null);
var names = cljs.core.nth.call(null,vec__33054,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__33054,tag_name,names){
return (function (p1__33049_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__33049_SHARP_));
});})(matches,vec__33054,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__33054,tag_name,names){
return (function (p1__33050_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__33050_SHARP_));
});})(matches,vec__33054,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__33057){
var vec__33064 = p__33057;
...
var tag = first__33066;
var content = seq__33065__$1;
...
var vec__33067 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__33067,(0),null);
var id = cljs.core.nth.call(null,vec__33067,(1),null);
var class$ = cljs.core.nth.call(null,vec__33067,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1523267564191